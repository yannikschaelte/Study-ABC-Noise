...
# thin out
exact_data[keys[1]] = exact_data[keys[1]][::10]
exact_data[keys[2]] = exact_data[keys[2]][::10]
...
pickle.dump(exact_data, open("exact_data_v4.dat", "wb"))
pickle.dump(noisy_data, open("noisy_data_v4.dat", "wb"))
pickle.dump(noise_vector, open("noise_vector_v4.dat", "wb"))
